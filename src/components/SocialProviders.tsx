...
export default function SocialProviders() {
  return (
    <div className=" w-full flex justify-items-center gap-6 mb-6 ">
      <div onClick={()=>socialLoginHandler("google")} className="rounded border bg-blue-100 hover:bg-blue-300 cursor-pointer text-2xl w-1/2 px-4 py-2 flex items-center justify-center ">
